...
Bringing the blog up was pretty painless, and full kudos must go to "mojombo":http://mojombo.github.com for both the sweet "jekyll":http://github.com/mojombo/jekyll idea and tool, and even css style (yes, I was that lazy). I love the ability to blog via a git commit, very cool and minimal 
overhead. The "Textile":http://hobix.com/textile/ format is pretty new to me (I know - where have I been ?) 
